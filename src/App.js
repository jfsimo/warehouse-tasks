...
const TASKS = [
  ...
  { id:"health-safety-induction",  name:"Health and safety induction",                              freq:"",             owners:["Rob Navito"]                                                    },
  ...
  { id:"truck-cleanliness",        name:"Manage Cleanliness of Trucks",                             freq:"",             owners:["Rob Navito"]                                                    },
  ...
  { id:"manage-egg-orders",        name:"Manage Egg orders and stock",                              freq:"Weekly",       owners:["Rich Ambrosio"]                                                 },
  { id:"replenish-rotate-stock",   name:"Replenish/Rotate stock",                                   freq:"Daily",        owners:["Koran","Mike Wong","Anthony Alessandrino"]                      },
  { id:"stock-management",         name:"Stock management (forecasting)",                           freq:"Daily",        owners:["Joe Ambrosio"]                                                  },
  { id:"close-orders",             name:"Close orders",                                             freq:"Daily",        owners:["Rob Navito"]                                                    },
  { id:"health-safety-monitoring", name:"Health & Safety Monitoring",                               freq:"",             owners:["Johnny Alessandrino"]                                           },
  { id:"ensure-staff-hours",       name:"Ensure staff do hours",                                    freq:"",             owners:["Rob Navito"]                                                    },
  { id:"manage-shorts",            name:"Manage shorts",                                            freq:"Daily",        owners:["Bala V","Rich Ambrosio"]                                        },
  { id:"quality-control",          name:"Quality control",                                          freq:"Daily",        owners:["Anthony Alessandrino"]                                          },
  { id:"hiring",                   name:"Hiring",                                                   freq:"Ad-Hoc",       owners:["Rob Navito","Grant Douglas"]                                    },
];
